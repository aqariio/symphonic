...
public class Symphonic implements ModInitializer {
    ...
    public static final LootFunctionType SET_COPPER_HORN_INSTRUMENT = Registry.register(Registry.LOOT_FUNCTION_TYPE, new Identifier(ID, "set_instrument"), new LootFunctionType(new SetCopperHornInstrumentFunction.Serializer()));
        ...
        LootTableEvents.MODIFY.register((resourceManager, lootManager, id, tableBuilder, source) -> {
            if (id.equals(LootTables.PILLAGER_OUTPOST_CHEST)) {
                tableBuilder.pool(LootPool.builder()
                        ...
                        .apply(SetCopperHornInstrumentFunction.builder(SymphonicInstrumentTags.REGULAR_COPPER_HORNS))
                );
            }
        });
    }
